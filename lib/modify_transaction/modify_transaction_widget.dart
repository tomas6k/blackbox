...
import 'modify_transaction_model.dart';
export 'modify_transaction_model.dart';

class ModifyTransactionWidget extends StatefulWidget {
  const ModifyTransactionWidget({super.key});

  @override
  State<ModifyTransactionWidget> createState() =>
      _ModifyTransactionWidgetState();
}

class _ModifyTransactionWidgetState extends State<ModifyTransactionWidget> {
  late ModifyTransactionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModifyTransactionModel());
