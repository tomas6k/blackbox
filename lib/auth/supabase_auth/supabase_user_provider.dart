...
class BlackboxSupabaseUser extends BaseAuthUser {
  BlackboxSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> blackboxSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = BlackboxSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
